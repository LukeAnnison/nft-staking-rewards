...
import "https://github.com/LukeAnnison/nft-staking-rewards/blob/master/Collection.sol";
import "https://github.com/LukeAnnison/nft-staking-rewards/blob/master/EtherealToken.sol";

contract DPSStaking is Ownable, IERC721Receiver {
    ...
    constructor(Collection _nft, EtherealToken _token) {
        nft = _nft;
        token = _token;
    }
    ...
    function earningsInfo(uint256[] calldata tokenIds)
        external
        view
